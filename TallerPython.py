    ...
    while True:
        try:
            ...
            if 0 <= percentage_number <= 100:
                ...
                print("\nEl valor del porcentaje no puede se menor a 1 ni mayor a 100.")
        except ValueError:
...
# Aqui estamos haciendo todos los calculos y asignado los valores a las variables para mostrar al usuario, ademas de algunas validaciones
        if valor.lower() == "n" :
            continuar = False
...
# A partir de aca estamos creando todo el enterno de la tabla, la que el usuario va a visualizar
        ...
        elif valor != "S" and valor != "s":
            print("\nPor favor ingresa 'N' para no o 'S' para sí.")
        else:
            break